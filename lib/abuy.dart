...
class ABuy extends StatefulWidget {
  const ABuy({Key? key}) : super(key: key);

  @override
  State<ABuy> createState() => _ABuyState();
}

class _ABuyState extends State<ABuy> {
  @override
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const Ashipping()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      elevation: 9,
