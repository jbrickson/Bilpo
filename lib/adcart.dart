...
class Adcart extends StatefulWidget {
  const Adcart({Key? key}) : super(key: key);

  @override
  _AdcartState createState() => _AdcartState();
}

enum SingingCharacter { paymaya, gcash, cash }

class _AdcartState extends State<Adcart> {
